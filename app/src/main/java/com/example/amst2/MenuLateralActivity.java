...
import com.example.amst2.databinding.ActivityMenuLateralBinding;
...
public class MenuLateralActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(binding.appBarMenuLateral.toolbar); //appBarMenuLateral.toolbar
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.video_ytbe, R.id.calendar_view, R.id.map_googlemaps,R.id.grafico_lineal)
